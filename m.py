...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*🚫 YOU ARE NOT APPROVED 🚫\n\nOops! It seems like you don't have permission to use the Attack command. To gain access and unleash the power of attacks, you can:\n👉 Contact an Admin or the Owner for approval @rdx_dev_owner*", parse_mode='Markdown')
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*🔆 WELCOME TO VIP RDX DEV DDOS BOT 🔆*", reply_markup=markup, parse_mode='Markdown')
